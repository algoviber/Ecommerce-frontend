...
import { AllProductsResponse, CategoriesResponse, DeleteProductRequest, MessageResponse, 
    NewProductRequest, SearchProductsRequest, SearchProductsResponse, SingleProductsResponse, 
    UpdateProductRequest } from "../../types/api-types";
...
export const productAPI = createApi({
    ...
    endpoints: (builder) => ({
        ...
        searchProducts: builder.query<SearchProductsResponse, SearchProductsRequest>({query:({price,search,sort,page,category})=>{
        ...
        productDetails: builder.query<SingleProductsResponse, string>({query:(id)=>id, providesTags:["product"],}),
